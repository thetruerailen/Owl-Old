...
class Owner(commands.Cog, name="owner"):
    ...
    async def sync(self, context: Context, scope: str) -> None:
        ...
        """
        embed = discord.Embed(
            description="Reloading slash commands...",color=0x9C84EF
        )
    ...
    @commands.command(
        name="unsync",
        description="Unsynchronizes the slash commands. DON'T USE DEBUG ONLY",
    )
    ...
    async def announce(self, context: commands.Context, channel: discord.TextChannel, *, message_content: str):
        embed = discord.Embed(
            title="Announcement",
